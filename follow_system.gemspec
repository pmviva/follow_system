...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{An active record follow system developed using ruby on rails 5 applying domain driven design and test driven development principles.}
